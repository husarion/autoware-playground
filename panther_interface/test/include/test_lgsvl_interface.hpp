...
#ifndef TEST_panther_interface_HPP_
#define TEST_panther_interface_HPP_
...
class PantherInterfaceTest : public ::testing::Test
{
protected:
  void SetUp() override
  {
    ...
    node_ = std::make_shared<rclcpp::Node>("panther_interface_test_node", "/gtest");

    panther_interface_ = std::make_unique<panther_interface::PantherInterface>(
      *node_,
      sim_ctrl_cmd_topic,
      sim_state_cmd_topic,
      sim_state_rpt_topic,
...
public:
  ...
  std::unique_ptr<panther_interface::PantherInterface> panther_interface_;
...
#endif  // TEST_panther_interface_HPP_
